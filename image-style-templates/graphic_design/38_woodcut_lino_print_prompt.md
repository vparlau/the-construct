...
# Config:
line_thickness    = "<e.g., fine, medium, thick>"
carving_style     = "<e.g., bold cuts, delicate lines, mixed>"
colour_palette    = "<e.g., black and white, two colours, multicolour>"
texture_intensity = "<e.g., subtle grain, moderate woodgrain, pronounced texture>"
print_size        = "<e.g., small vignette, medium print, large poster>"
background_detail= "<e.g., none, simple pattern, carved border>"
mood             = "<e.g., folk art, dramatic, whimsical>"
